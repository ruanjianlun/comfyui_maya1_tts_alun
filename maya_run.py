...
def main():
    ...
    # text = "Hello! This is Maya1 <curious> the best open source voice AI model with emotions."
    text = "<laugh> ComfyUI? <sigh> Another node-based stable diffusion UI! <angry> I just got my YAML files right in Automatic1111! <gasp> But... it's fast? <excited> Super fast and deeply customizable, they say! <chuckle> You build your image generation workflows like a digital Frankenstein. <whisper> Get ready for a steep learning curve, though. <scream> My GPU bill! <snort> It's the only way for complex, repeatable magic! <giggle> Have fun falling down the rabbit hole! <exhale> It's worth it"
